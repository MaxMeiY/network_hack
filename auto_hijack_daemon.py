...
if client_ip:
    print("Hijacking TCP connections from %s to %s on port %s" % (client_ip,
                             srv_ip,
                             srv_port))
    ...
    print("Hijacking all TCP connections to %s on port %s" %(srv_ip,srv_port))
    filter = 'tcp and port ' + str(srv_port) + \
             ' and host ' + srv_ip
